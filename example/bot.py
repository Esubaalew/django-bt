...
from example.api import get_categories, get_subcategories, get_brands, get_models, get_products, get_product_details, check_stock_availability, search_items, get_brand_details, get_model_details, get_subcategory_details
...
async def bot_tele(text):
    ...
    application.add_handler(InlineQueryHandler(inline_search))  # Corrected the missing parenthesis
